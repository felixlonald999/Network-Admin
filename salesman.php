...
$query          = mysqli_query($conn2, $stmt) or die(mysqli_error($conn2));
$data_salesman  = mysqli_fetch_all($query, MYSQLI_ASSOC);
?>
...
<body>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="salesman.php" method="GET">
                            <div class="row">
                                <div class="col-md-3">
    ...
    <div class="modal fade" id="mutasiSalesmanModal" tabindex="-1" role="dialog" aria-labelledby="mutasiSalesmanModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="proses/mutasi_salesman.php" method="POST">
                                ...
                                <select name="kode_dealer" id="kode_dealer" class="form-control select2" required>
                                    ...
                                    <?php foreach ($data_area as $key => $value): ?>
                                        <optgroup label="<?= $value['area'] ?>">
                                            <?php
                                            $stmt_dealer = "SELECT * FROM `dealer` WHERE area = '{$value['area']}' AND status_group = 'M/D' ORDER BY nama_dealer ASC";
                                            $query_dealer = mysqli_query($conn2, $stmt_dealer) or die(mysqli_error($conn2));
                                            $data_dealer = mysqli_fetch_all($query_dealer, MYSQLI_ASSOC);
                                            ?>
    ...
    <div class="modal fade" id="tambahSalesmanModal" tabindex="-1" role="dialog" aria-labelledby="tambahSalesmanModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="proses/add_salesman.php" method="POST">
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
    ...
    <script>
        ...
        $(document).on('click', '.btn-toggle-status', function() {
            ...
            $.ajax({
                url: 'proses/ubah_status_salesman.php',
                type: 'POST',
                data: {
                    id: id,
                    status: newStatus
