...
if ($tahun && $bulan && $bulan_akhir) {
    ...
    $conditions[] = "`tanggal_terakhir_service` BETWEEN ? AND ?";
    $params[] = $tanggal_awal;
    $params[] = $tanggal_akhir;
    $types .= 'ss';
} else if ($tahun && $bulan) {
    $conditions[] = "YEAR(`tanggal_terakhir_service`) = ? AND MONTH(`tanggal_terakhir_service`) = ?";
    $params[] = $tahun;
    $params[] = $bulan;
    $types .= 'ii';
} else if ($tahun) {
    $conditions[] = "YEAR(`tanggal_terakhir_service`) = ?";
    $params[] = $tahun;
    $types .= 'i';
} else if ($bulan) {
    $conditions[] = "MONTH(`tanggal_terakhir_service`) = ?";
    $params[] = $bulan;
    $types .= 'i';
} else if ($bulan && $bulan_akhir) {
    $conditions[] = "MONTH(`tanggal_terakhir_service`) BETWEEN ? AND ?";
    $params[] = $bulan;
    $params[] = $bulan_akhir;
    $types .= 'ii';
}
